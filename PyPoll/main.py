...
with open(budget_data_csv, newline="") as csvfile:
    ...
    for row in csvreader:
        ...
        if candidate_in in candidates_list :
            candidate_index = candidates_list .index(candidate_in)
            ...
            candidates_list .append(candidate_in)
...
print('~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~')
for x in range(len(candidates_list )):
    print(f'{candidates_list [x]} : {pct[x]}% ({candidate_vote_count[x]})')
print('~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~')
...
with open(output_file, "w", newline="") as datafile:
    ...
    datafile.write('~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~\n')
    for x in range(len(candidates_list )):
        datafile.write(f'{candidates_list [x]} : {pct[x]}% ({candidate_vote_count[x]})\n')
    datafile.write('~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~\n')
